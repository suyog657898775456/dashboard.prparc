          ...
          <div className="flex items-center justify-between text-sm text-gray-500">
            ...
            <div className="flex space-x-2 items-center">
              ...
              <button
                ...
                className="p-1 bg-blue-200 text-blue-600 rounded-lg"
              >
                <EditIcon />
              </button>
              <button
...
const Syllabus = () => {
  ...
  const handleFileSelect = (e) => {
    ...
    if (files?.[0]?.type === "application/pdf") setSelectedFile(files[0]);
  };
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        showAddPanel &&
        !document.getElementById("add-panel")?.contains(event.target) &&
        !document.getElementById("add-button")?.contains(event.target)
      )
        handleCancelAdd();
      if (
        showEditPanel &&
        !document.getElementById("edit-panel")?.contains(event.target)
      )
        cancelEdit();
    };
  ...
  if (loading)
    return <div className="p-10 text-center">Loading Syllabus...</div>;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 relative overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Panel components remain functionally the same as your UI code */}
        {showAddPanel && (
          <div
            id="add-panel"
          ...
          >
            <div className="flex justify-between items-center mb-6 border-b pb-4">
              ...
              <button onClick={handleCancelAdd} className="text-gray-400">
                <XIcon />
              </button>
            </div>
            ...
            <div className="pt-6 border-t flex space-x-3">
              ...
              <button
                ...
                className="flex-1 py-3 bg-blue-400/30 text-blue-950 font-medium"
              >
                Upload
              </button>
            </div>
        ...
        {showEditPanel && editingFile && (
          ...
          >
            <div className="flex justify-between items-center mb-6 border-b pb-4">
              <h2 className="text-xl font-semibold">Edit Syllabus</h2>
            ...
            <div className="flex-1 space-y-6 overflow-y-auto">
              ...
              />
              <div
                className="border-2 border-dashed rounded-xl p-6 text-center cursor-pointer border-gray-300"
